...
Will the return always be an array with one added element?
...
//set parameter
//concat array with one new value and return new array
const addExtra = listOfNumbers => listOfNumbers.concat('new item');