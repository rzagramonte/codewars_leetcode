...
//set parameter
//create conditional statement for accepted notes and a default return value
const changeMe = moneyIn => moneyIn == '£5' ? '20p '.repeat(25).trim() : moneyIn == '£2' ? '20p '.repeat(10).trim() : moneyIn == '£1' ? '20p '.repeat(5).trim() : moneyIn == '50p' ? '20p '.repeat(2) + '10p' : moneyIn == '20p' ? '10p '.repeat(2).trim() : moneyIn;
