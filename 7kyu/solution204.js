...
Will the return be an array of integers?
...
create variables for cumulative, sign, and array
create for loop where each iteration pushes index + cumulative * sign to the array
add index to cumulative and reassign cumulative to sum
return array
*/
const sumOfN = n => {
    let c = 0;
