...
Repetition of numbers in the array/list could occur , So duplications are not included when summing, (i.e) the numbers added only once.
...
const maxTriSum = n => [...new Set(n)].sort((a,b)=>b-a).slice(0,3).reduce((a,c)=>a+c);