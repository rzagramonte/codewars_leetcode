...
TODO:
reduce all values landing on odd indicies
reduce all values landing on even indicies
return two values in an array
*/

const rowWeights = a => [a.reduce((a,c,i)=>a+(i%2?0:c),0), a.reduce((a,c,i)=>a+(i%2?c:0),0)];