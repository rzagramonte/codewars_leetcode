...
Will the exponent never be 1?
Will either number never be 0?
Will the return always be a string?
Will the first number in the string be the product of the two parameters?
Will the second and last number in the string be the exponent minus 1?

console.log(derive(7,8), "56x^7");
console.log(derive(5,9), "45x^8");
*/

//declare const variable that will be assigned to an arrow function
//set parameters
