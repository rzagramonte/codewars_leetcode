...
TODO:
split by " "
find ASCII code for first three characters of each element
convert to hex
add "00" where necessary
*/

const wordsToHex = words => words.split(' ').map(e=>`#${(e.charCodeAt(0) || "00").toString(16)}${(e.charCodeAt(1) || "00").toString(16) }${(e.charCodeAt(2)|| "00").toString(16)}`);
