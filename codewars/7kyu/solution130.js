...
//declare constant variable findScreenHeight which will be assigned to an arrow function
//set parameters width and ratio
//interpolate width and calculation result for height into a string
const findScreenHeight = (width, ratio) =>`${width}x${(width/ratio.split(':')[0])*ratio.split(':')[1]}`;