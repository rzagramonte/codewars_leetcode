...
Will the arguments always be an object and an array of strings?
Will the return always be a string?

console.log(fifa({'Home':'£75', 'Away':'£5000', 'Draw':'£1324'}, ['1-0', '2-3', '0-1']), '£5075');

TODO:
create variable of winnings set to 0
three ifs
return winnings
*/
...
const fifa = (ticket, results) => {
  ...
  if(+results[0][0] > +results[0][2]) winnings += +ticket['Home'].slice(1);
  if(+results[1][0] < +results[1][2]) winnings += +ticket['Away'].slice(1);
  if (+results[2][0] == +results[2][2]) winnings += +ticket['Draw'].slice(1);
