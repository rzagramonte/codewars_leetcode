...
Will the arguments passed into the function's parameters always be a number and an array of numbers?
Will the return always be an array of numbers?

console.log(relatively_prime(8, [1, 2, 3, 4, 5, 6, 7]), [1, 3, 5, 7]);
console.log(relatively_prime(15, [72, 27, 32, 61, 77, 11, 40]), [32, 61, 77, 11]);
console.log(relatively_prime(210, [15, 100, 2222222, 6, 4, 12369, 99]), []);
*/

//create function that find GCP
//filter elements where gcp equals 1
const relativelyPrime = (n, arr) => {
    const gcd = (a, b) => {
      while (b !== 0) {
        [a, b] = [b, a % b];
      }
