...
/*
Will the arguments passed into the function's parameters always be an array and a number?
...
//slice array from right using -s
//reduce array and return product
const maxProduct = (n, s) => n.sort((a,b)=>a-b).slice(-s).reduce((a,c)=>a*c,1);