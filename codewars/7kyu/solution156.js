...
//create new array the length of the sorted input array
//iterate over empty slotted array
//if index mod 2 is truthy shift off the first element and return it, else pop off the last element and return it
